				...
				<div class="container">
					<div align="left" class="col-md-1">
						<button id="btnNuevaActividad" name="btnNuevaActividad"
							class="btn btn-warning" type="submit">Agregar Permiso</button>
					</div>
				</div>
			</div>
		</fieldset>
			...
			<div class="row">
				<div class="table-responsive">
					<table class="table table-condensed table-hover">
						...
						<tbody>
							<c:forEach items="${permisoobj}" var="PermisosDTO">
								<tr>
									<td><c:out value="${ PermisosDTO.modificadoPor}" /></td>
									<td><c:out value="${ PermisosDTO.fechaModificacion}" /></td>
