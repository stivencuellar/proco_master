				...
				<div class="container">
					<div align="left" class="col-md-1">
						<button id="btnNuevaActividad" name="btnNuevaActividad"
							class="btn btn-warning" type="submit">Agregar Evidencia</button>
					</div>
				</div>
			</div>
		</fieldset>
			...
			<div class="row">
				<div class="table-responsive">
					<table class="table table-condensed table-hover">
						...
						<tbody>
							<c:forEach items="${evidenciaobj}" var="EvidenciaDTO">
								<tr>
									<td><c:out value="${ EvidenciaDTO.urlEvidencia}" /></td>
									<td><c:out value="${ EvidenciaDTO.modificadoPor}" /></td>
									<td><c:out value="${ EvidenciaDTO.fechaModificacion}" /></td>
