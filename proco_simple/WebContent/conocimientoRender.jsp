...
<title>PROCO - Conocimiento</title>
				...
				<div class="container">
					<div align="left" class="col-md-1">
						<button id="btnNuevaActividad" name="btnNuevaActividad"
							class="btn btn-warning" type="submit">Agregar Conocimiento</button>
					</div>
				</div>
			</div>
		</fieldset>
			...
			<div class="row">
				<div class="table-responsive">
					<table class="table table-condensed table-hover">
						...
						<tbody>
							<c:forEach items="${conocimientoobj}" var="ConocimientoDTO">
								<tr>
									<td><c:out value="${ ConocimientoDTO.nivelGusto}" /></td>
									<td><c:out value="${ ConocimientoDTO.modificadoPor}" /></td>
									<td><c:out value="${ ConocimientoDTO.fechaModificacion}" /></td>
