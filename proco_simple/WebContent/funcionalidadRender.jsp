...
<title>PROCO - Funcionalidades</title>
				...
				<div class="container">
					<div align="left" class="col-md-1">
						<button id="btnNuevaActividad" name="btnNuevaActividad"
							class="btn btn-warning" type="submit">Agregar Funcionalidad</button>
					</div>
				</div>
			</div>
		</fieldset>
			...
			<div class="row">
				<div class="table-responsive">
					<table class="table table-condensed table-hover">
						...
						<tbody>
							<c:forEach items="${funcionalidadobj}" var="FuncionalidadesDTO">
								<tr>
									<td><c:out value="${ FuncionalidadesDTO.nombre}" /></td>
									<td><c:out value="${ FuncionalidadesDTO.urlControl}" /></td>
									<td><c:out value="${ FuncionalidadesDTO.modificadoPor}" /></td>
									<td><c:out value="${ FuncionalidadesDTO.fechaModificacion}" /></td>
...
<!-- 											type="submit">eliminar</button>Eliminar.png -->
